...
st.write('*Mes lettres sont à votre disposition pour écrire le mot de votre choix et l’offrir à ceux que vous aimez.*')

st.write(f'''
    <a target="_self" href="https://nicolasesnis-fotomo--galerie-ehy3aw.streamlitapp.com/Mon_panier">
        <button style="
